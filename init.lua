...
local config = {
  ...
  mappings = {
    ...
    n = {
      ...
      ["<A-j>"] = { ":m .+1<cr>==" },
      ["<A-k>"] = { ":m .-2<cr>==" },
      ["<leader><cr>"] = { ":call jukit#send#line()<cr>" },
      -- Move Between Cell in vim_jukit
      ...
      -- Create Cell in vim_jukit
      -- ["<C-K>"] = { ":call jukit#cells#create_above(0)<cr>" },
      -- ["<C-J>"] = { ":call jukit#cells#create_below(0)<cr>" },
    },
    t = {
